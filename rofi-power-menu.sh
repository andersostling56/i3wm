...
all=(shutdown openvpn reboot suspend hibernate logout lockscreen)
...
texts[openvpn]="Toggle VPN on/off"
texts[switchuser]="Switch user"
texts[logout]="log out"
texts[suspend]="Suspend session"
texts[hibernate]="Hibernate to disk"
texts[reboot]="Reboot"
